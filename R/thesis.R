...
#' to specify using the University of California Thesis LaTeX template and cls files.
#'
#' @export
...
#' }
thesis_pdf <- function(toc = TRUE, toc_depth = 3, highlight = "default", pandoc_args = "--top-level-division=chapter", ...){
